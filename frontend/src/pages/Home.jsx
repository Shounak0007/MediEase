  ...
  return (
    <div className="bg-[#f5f9fa]">
      ...
      <section className="hero__section pt-[60px] 2xl:h-[800px]">
        <div
          className="container flex justify-center mb-0 align-bottom"
      ...
      <section>
        <div className="container">
          <div className="lg:w-[470px] mx-auto">
            <h2 className="font-sans heading text-center">
          ...
          <div className="py-[30px] px-5 flex justify-around border-b-[1px] border-gray-200 hover:shadow-lg">
            <div>
              <div className="mt-[30px]">
                <h2 className="font-sans text-[26px] leading-9 text-headingColor font-[700]">
                  Find a Doctor
                </h2>
              </div>
